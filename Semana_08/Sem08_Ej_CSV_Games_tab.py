...
#3. No sé si este salió bien porque cuando lo abro en excel me lo lee todo pegado, sin comas ni tabulaciones.
...
def main ():
    ...
    write_a_csv_file_from_a_list ("my_games_tab.csv",final_list_of_games,dictionary_keys)

    print(f""""The complete data is:
        {final_list_of_games}

        A file named ' my_games_tab.csv ' was made with this information.
            """)
